...
import com.matt.crowdfinder.BusiDetailActivity.DownloadPhotoTask;
...
public class AccountActivity extends Activity implements OnClickListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
	    ...
	    if ( account.avatarLink != null && account.avatarLink.length() > 0 )
	    	new Global.DownloadPhotoForImageViewTask(avatarView).execute(account.avatarLink);
...
//				finish();
	...
	class SendSubmitReq extends AsyncTask<String, Void, Void> {
		String sResponse = "";
		private ProgressDialog progressDialog;
		@Override
		protected void onPreExecute() {
			progressDialog = ProgressDialog.show(AccountActivity.this,"Please wait...", "Logging in...", true);
		}

		@Override
		protected Void doInBackground(String... params) {
			
			String url = Global.ACCOUNT_MODIFY_API_URL;
			Account account = Account.getInstance();
		...
		protected void onPostExecute(Void result) {
			try
			{
				...
				if (res.equals("succ"))
				{
					Toast.makeText(getApplicationContext(), "Account Submission successful!", Toast.LENGTH_LONG).show();
